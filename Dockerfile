...
WORKDIR /src
COPY ["Backend/Mango.Services.CouponAPI/Mango.Services.CouponAPI.csproj", "Backend/Mango.Services.CouponAPI/"]
RUN dotnet restore "./Backend/Mango.Services.CouponAPI/Mango.Services.CouponAPI.csproj"
COPY . .
WORKDIR "/src/Backend/Mango.Services.CouponAPI"
